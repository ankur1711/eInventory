...
public class TestTaxExemptSales extends PageObjects {
	...
	public void viewDateRangeOptions(GroupSalesData data) throws InterruptedException, ParseException {
		// select user number
		...
		Assert.assertTrue(checkDropDownValues(getTaxExemptSalesPage(driver).getOptionsForDateRangeDropDown(),
				"Custom Date Range"), "Custom Date Range option was not displayed");
		Assert.assertTrue(
				checkDropDownValues(getTaxExemptSalesPage(driver).getOptionsForDateRangeDropDown(), "3 Months"),
				"3 Months option was not displayed");
		Assert.assertTrue(
				checkDropDownValues(getTaxExemptSalesPage(driver).getOptionsForDateRangeDropDown(), "6 months"),
				"6 Months option was not displayed");
		Assert.assertTrue(
				checkDropDownValues(getTaxExemptSalesPage(driver).getOptionsForDateRangeDropDown(), "9 months"),
				"9 Months option was not displayed");
		Assert.assertTrue(
				checkDropDownValues(getTaxExemptSalesPage(driver).getOptionsForDateRangeDropDown(), "12 months"),
				"12 Months option was not displayed");
		// Work Around
		// getTaxExemptSalesPage(driver).selectDateRangeFromDropDown("6
		// months");
		...
		Assert.assertEquals(getTaxExemptSalesPage(driver).getStartDate(), getDateByMonths("-3"),
				"Start date was not displayed as expected date - " + getDateByMonths("-3"));
		// Verify whether the end date is current date
		Assert.assertEquals(getTaxExemptSalesPage(driver).getEndDate(), getDateByMonths("0"),
				"End date was not displayed as current date - " + getDateByMonths("0"));
		...
		List<WebElement> dateElementsList3Months = getTaxExemptSalesPage(driver).getListOfDateElements();
		for (WebElement date : dateElementsList3Months) {
			String dateTimeDisplayedonUI = date.getText();
			if (!(dateTimeDisplayedonUI.isEmpty() || dateTimeDisplayedonUI.contains("Invalid"))) {
				String dateDisplayedonUI = dateTimeDisplayedonUI.substring(0, 10);
				Assert.assertTrue(
						verifyDateWithInRange(getTaxExemptSalesPage(driver).getStartDate(),
								getTaxExemptSalesPage(driver).getEndDate(), dateDisplayedonUI),
						"Date displayed '" + dateDisplayedonUI + "' was not with the specified range '3 Months'");
				Reporter.log("Date displayed '" + dateDisplayedonUI + "' was with the specified range '3 Months'<br>");
			}
		}
		...
		Assert.assertEquals(getTaxExemptSalesPage(driver).getStartDate(), getDateByMonths("-6"),
				"Start date was not displayed as expected date - " + getDateByMonths("-6"));
		// Verify whether the end date is current date
		Assert.assertEquals(getTaxExemptSalesPage(driver).getEndDate(), getDateByMonths("0"),
				"End date was not displayed as current date - " + getDateByMonths("0"));
		// Click on Show Results button
		...
		// on tax exempt sales landing page
		// Get all the displayed date for the records
		List<WebElement> dateElementsList6Months = getTaxExemptSalesPage(driver).getListOfDateElements();
		for (WebElement date : dateElementsList6Months) {
			...
			if (!(dateTimeDisplayedonUI.isEmpty() || dateTimeDisplayedonUI.contains("Invalid"))) {
				...
				Assert.assertTrue(
						verifyDateWithInRange(getTaxExemptSalesPage(driver).getStartDate(),
								getTaxExemptSalesPage(driver).getEndDate(), dateDisplayedonUI),
						"Date displayed '" + dateDisplayedonUI + "' was not with the specified range '6 Months'");
				Reporter.log("Date displayed '" + dateDisplayedonUI + "' was with the specified range '6 Months'<br>");
			}
		}
		...
		Assert.assertEquals(getTaxExemptSalesPage(driver).getStartDate(), getDateByMonths("-9"),
				"Start date was not displayed as expected date - " + getDateByMonths("-9"));
		// Verify whether the end date is current date
		Assert.assertEquals(getTaxExemptSalesPage(driver).getEndDate(), getDateByMonths("0"),
				"End date was not displayed as current date - " + getDateByMonths("0"));
		// Click on Show Results button
		...
		// on tax exempt sales landing page
		// Get all the displayed date for the records
		List<WebElement> dateElementsList9Months = getTaxExemptSalesPage(driver).getListOfDateElements();
		for (WebElement date : dateElementsList9Months) {
			...
			if (!(dateTimeDisplayedonUI.isEmpty() || dateTimeDisplayedonUI.contains("Invalid"))) {
				...
				Assert.assertTrue(
						verifyDateWithInRange(getTaxExemptSalesPage(driver).getStartDate(),
								getTaxExemptSalesPage(driver).getEndDate(), dateDisplayedonUI),
						"Date displayed '" + dateDisplayedonUI + "' was not with the specified range '9 Months'");
				Reporter.log("Date displayed '" + dateDisplayedonUI + "' was with the specified range '9 Months'<br>");
			}
		}
		...
		Assert.assertEquals(getTaxExemptSalesPage(driver).getStartDate(), getDateByMonths("-12"),
				"Start date was not displayed as expected date - " + getDateByMonths("-12"));
		// Verify whether the end date is current date
		Assert.assertEquals(getTaxExemptSalesPage(driver).getEndDate(), getDateByMonths("0"),
				"End date was not displayed as current date - " + getDateByMonths("0"));
		// Click on Show Results button
		...
		// on tax exempt sales landing page
		// Get all the displayed date for the records
		List<WebElement> dateElementsList12Months = getTaxExemptSalesPage(driver).getListOfDateElements();
		for (WebElement date : dateElementsList12Months) {
			...
			if (!(dateTimeDisplayedonUI.isEmpty() || dateTimeDisplayedonUI.contains("Invalid"))) {
				...
				Assert.assertTrue(
						verifyDateWithInRange(getTaxExemptSalesPage(driver).getStartDate(),
								getTaxExemptSalesPage(driver).getEndDate(), dateDisplayedonUI),
						"Date displayed '" + dateDisplayedonUI + "' was not with the specified range '12 Months'");
				Reporter.log("Date displayed '" + dateDisplayedonUI + "' was with the specified range '12 Months'<br>");
			}
		}
		// Select the date range as Custom date range
		getTaxExemptSalesPage(driver).selectDateRangeFromDropDown("Custom Date Range");
		...
		// Get all the displayed date for the records
		List<WebElement> dateElementsListCustomDate = getTaxExemptSalesPage(driver).getListOfDateElements();
		for (WebElement date : dateElementsListCustomDate) {
			...
			if (!(dateTimeDisplayedonUI.isEmpty() || dateTimeDisplayedonUI.contains("Invalid"))) {
				...
				Assert.assertTrue(
						verifyDateWithInRange(getTaxExemptSalesPage(driver).getStartDate(),
								getTaxExemptSalesPage(driver).getEndDate(), dateDisplayedonUI),
						"Date displayed '" + dateDisplayedonUI
	...
	public void viewTotalOfTaxExemptSales(GroupSalesData data) throws InterruptedException, ParseException {
		// Select user number
		getHomePage(driver).selectUser(data.getUserNumber());
		// Select Store Number
		getHomePage(driver).selectStore(data.getStoreNumber());
		...
		for (WebElement date : dateElementsList3Months) {
			...
			if (!(dateTimeDisplayedonUI.isEmpty() || dateTimeDisplayedonUI.contains("Invalid"))) {
				...
				Assert.assertTrue(
						verifyDateWithInRange(getTaxExemptSalesPage(driver).getStartDate(),
								getTaxExemptSalesPage(driver).getEndDate(), dateDisplayedonUI),
						"Date displayed '" + dateDisplayedonUI + "' was not with the specified range '3 Months'<br>");
				Reporter.log("Date displayed '" + dateDisplayedonUI + "' was with the specified range '3 Months'<br>");
			}
		}
		// View "Total of Tax Exempt Sales"
		Assert.assertEquals(getTaxExemptSalesPage(driver).getTotalTaxExemptSalesDisplayed(),
		...
		Reporter.log("Total of Tax Exempt Sales displayed '"
				...
				+ getTaxExemptSalesPage(driver).getTotalTaxExemptValue() + "'<br>");
		// Select the date range as 6 months
		getTaxExemptSalesPage(driver).selectDateRangeFromDropDown("6 months");
		// Verify whether the start date is 6 months from current date
		Assert.assertEquals(getTaxExemptSalesPage(driver).getStartDate(), getDateByMonths("-6"),
	...
	public void viewTaxExemptSalesLandingPageFields(GroupSalesData data) {
		...
		// Page
		Assert.assertTrue(getTaxExemptSalesPage(driver).taxExemptDateAndTime.isDisplayed(),
		...
		Assert.assertTrue(getTaxExemptSalesPage(driver).taxExemptRegisterField.isDisplayed(),
		...
		Assert.assertTrue(getTaxExemptSalesPage(driver).taxExemptAmountField.isDisplayed(),
		...
		// Landing Page
		Assert.assertTrue(getTaxExemptSalesPage(driver).taxExemptUserField.isDisplayed(),
		...
		// Page
		Assert.assertTrue(getTaxExemptSalesPage(driver).taxExemptOrganizationField.isDisplayed(),
		...
		// Page
		Assert.assertTrue(getTaxExemptSalesPage(driver).taxIDNumberField.isDisplayed(),
		...
		// Landing page
		Assert.assertTrue(getTaxExemptSalesPage(driver).depositStatus.isDisplayed(),
	...
	public void verifyUserAbleToEditTaxExemptSalesForFinalizedDeposit(GroupSalesData data) {
		...
		for (int count = 0; count < editButtonElemens.size(); count++) {
			...
			Assert.assertTrue(getTaxExemptSalesPage(driver).organizationTextBox().isEnabled(),
					"User should not be able to edit the Organization Name");
			// Verify TaxIdNumber is enabled
			Assert.assertTrue(getTaxExemptSalesPage(driver).taxIdNumberTextBox().isEnabled(),
					"User should not be able to edit the Tax Id Number");
			// Verify ContactNameText is enabled
			Assert.assertTrue(getTaxExemptSalesPage(driver).contactNameTextBox().isEnabled(),
					"User should not be able to edit the Contact Name");
			// Verify AddressLine1 Text box is enabled
			Assert.assertTrue(getTaxExemptSalesPage(driver).addressLine1TextBox().isEnabled(),
					"User Should not be able to edit the Address Line1");
			// Verify AddressLine2 Text box is enabled
			Assert.assertTrue(getTaxExemptSalesPage(driver).addressLine2TextBox().isEnabled(),
					"Address Line2 is not enabled");
			// Verify City Text box is enabled
			Assert.assertTrue(getTaxExemptSalesPage(driver).cityTextBox().isEnabled(), "City is not enabled");
			// Verify email text box is enabled
			Assert.assertTrue(getTaxExemptSalesPage(driver).emailTextBox().isEnabled(),
			...
			Assert.assertTrue(getTaxExemptSalesPage(driver).phoneNumberTextBox().isEnabled(),
			...
			Assert.assertTrue(getTaxExemptSalesPage(driver).zipCodeTextBox().isEnabled(),
			...
			Assert.assertTrue(getTaxExemptSalesPage(driver).stateDropDown().isEnabled(),
	...
	public void verifyManualEntryFields(GroupSalesData data) {
		...
		List<WebElement> editButtonElemens = driver
				.findElements(By.xpath("//table[@id='tax_exempt_table']//button[@value='Edit']"));
		for (int count = 0; count < editButtonElemens.size(); count++) {
			getTaxExemptSalesPage(driver).clickOnEditButton(count + 1);
			Reporter.log("OPen the " + (count + 1) + " entry in Tax Exempt Sales<br>");
			...
			getTaxExemptSalesPage(driver).taxIdNumberTextBox()
					.sendKeys("TID" + Integer.toString(generateRandomNumber()));

			getTaxExemptSalesPage(driver).contactNameTextBox().click();
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//input[@id='contact_te0']"))).clear();
			getTaxExemptSalesPage(driver).contactNameTextBox()
					.sendKeys("Test Contact Name_" + Integer.toString(generateRandomNumber()));

			getTaxExemptSalesPage(driver).addressLine1TextBox().click();
			wait.until(ExpectedConditions
					.elementToBeClickable(By.xpath("//div[@id='detail_te0']/div[2]/div[1]/div/input"))).clear();
			getTaxExemptSalesPage(driver).addressLine1TextBox()
					.sendKeys("Test Address 1_" + Integer.toString(generateRandomNumber()));

			getTaxExemptSalesPage(driver).addressLine2TextBox().click();
			getTaxExemptSalesPage(driver).addressLine2TextBox().clear();
			getTaxExemptSalesPage(driver).addressLine2TextBox()
					.sendKeys("Test Address 2_" + Integer.toString(generateRandomNumber()));

			getTaxExemptSalesPage(driver).cityTextBox().click();
			getTaxExemptSalesPage(driver).cityTextBox().clear();
			getTaxExemptSalesPage(driver).cityTextBox()
					.sendKeys("Test City_" + Integer.toString(generateRandomNumber()));
...
*/
			...
			getTaxExemptSalesPage(driver).emailTextBox()
					.sendKeys("TestEmailAddr_" + Integer.toString(generateRandomNumber()) + "@mcd.com");
			// Enter Phone Number
			...
			getTaxExemptSalesPage(driver).submitTaxExemptSalesModularWindow().click();
		}
	...
	public void filterTaxExemptSalesDetailsByOrganizationUserAndDepositCode(GroupSalesData data) {
		getHomePage(driver).selectUser(data.getUserNumber());
		// Select Store Number
		getHomePage(driver).selectStore(data.getStoreNumber());
		// Open E-Cash - Other Cash Functions Menu
		...
		getHomePage(driver).selectOtherCashFunctionsOptions("Group Sales");
		getTaxExemptSalesPage(driver).clickTaxExemptSales();
		getTaxExemptSalesPage(driver).selectOrganizationName("Test");
		getTaxExemptSalesPage(driver).clickOnShowResultsButton(1);
		sleep(1000);
		List<WebElement> organizationNameList = getTaxExemptSalesPage(driver).getListOfOrganizationName();
		for (WebElement organization : organizationNameList) {
			String organizationDisplayedOnUI = organization.getText().trim();
			Assert.assertEquals(organizationDisplayedOnUI, "Test");
			Reporter.log("Organization name was displayed as expected - " + organizationDisplayedOnUI + "<br>");
		}
		// View "Total of Tax Exempt Sales"
		Assert.assertEquals(getTaxExemptSalesPage(driver).getTotalTaxExemptSalesDisplayed(),
				getTaxExemptSalesPage(driver).getTotalTaxExemptValue(),
		...
		getTaxExemptSalesPage(driver).clickOnShowResultsButton(1);
		sleep(1000);
		List<WebElement> userNameList = getTaxExemptSalesPage(driver).getListOfUserID();
		...
		getTaxExemptSalesPage(driver).clickOnShowResultsButton(1);
		sleep(1000);
		List<WebElement> depositStatusList = getTaxExemptSalesPage(driver).getListDepositStatus();
		for (WebElement depositStatus : depositStatusList) {
			String depositStatusDisplayedOnUI = depositStatus.getText().trim();
			Assert.assertEquals(depositStatusDisplayedOnUI, "In-Progress");
		}
		Assert.assertEquals(getTaxExemptSalesPage(driver).getTotalTaxExemptSalesDisplayed(),
				getTaxExemptSalesPage(driver).getTotalTaxExemptValue(),
		...
		getTaxExemptSalesPage(driver).clickOnShowResultsButton(1);
		sleep(1000);
		List<WebElement> inprogressDepositStatusList = getTaxExemptSalesPage(driver).getListOfInprogressDepositStatus();
		for (WebElement inprogressDepositStatus : inprogressDepositStatusList) {
			String inprogressDepositStatusOnUI = inprogressDepositStatus.getText().trim();
	...
	public void sortTaxExemptSalesDetailsByFieldDisplayedOnTaxExemptSalesPage(GroupSalesData data)
		...
		List<WebElement> dateElementsDisplayedOnUIDescending = getTaxExemptSalesPage(driver).getListOfDateElements();
		for (int count = 0; count < dateElementsDisplayedOnUIDescending.size() - 2; count++) {
			...
			Date firstDateDisplayedOnUI = df
					.parse(dateElementsDisplayedOnUIDescending.get(count).getText().substring(0, 10));
			Date secondDateDisplayedOnUI = df
					.parse(dateElementsDisplayedOnUIDescending.get(count + 1).getText().substring(0, 10));
			// Verify the dates were in descending order
			Assert.assertTrue(
					firstDateDisplayedOnUI.after(secondDateDisplayedOnUI)
							|| firstDateDisplayedOnUI.equals(secondDateDisplayedOnUI),
					df.format(firstDateDisplayedOnUI) + " was not equal to or after "
							+ df.format(secondDateDisplayedOnUI)
							+ ", so dates were not not in descending order by default");
			Reporter.log(df.format(firstDateDisplayedOnUI) + " was equal to or after "
		...
		// Get all the date elements as it was in descending order by default
		List<WebElement> dateElementsDisplayedOnUIAscending = getTaxExemptSalesPage(driver).getListOfDateElements();
		for (int count = 0; count < dateElementsDisplayedOnUIAscending.size() - 2; count++) {
			// Get the date alone and parse it as per the application format
			Date firstDateDisplayedOnUI = df
					.parse(dateElementsDisplayedOnUIAscending.get(count).getText().substring(0, 10));
			Date secondDateDisplayedOnUI = df
					.parse(dateElementsDisplayedOnUIAscending.get(count + 1).getText().substring(0, 10));
			// Verify the dates were in descending order
			Assert.assertTrue(
					firstDateDisplayedOnUI.before(secondDateDisplayedOnUI)
							|| firstDateDisplayedOnUI.equals(secondDateDisplayedOnUI),
					df.format(firstDateDisplayedOnUI) + " was not equal to or before "
							+ df.format(secondDateDisplayedOnUI)
							+ ", so dates were not not in ascending order by default");
			Reporter.log(df.format(firstDateDisplayedOnUI) + " was equal to or before "
					+ df.format(secondDateDisplayedOnUI) + "<br>");
		}
		...
		List<WebElement> registerElementsDisplayedOnUIAscending = getTaxExemptSalesPage(driver)
				.getListOfRegisterElements();
		for (int count = 0; count < registerElementsDisplayedOnUIAscending.size() - 1; count++) {
			int firstRegisteIdDisplayedOnUI = Integer
					.parseInt(registerElementsDisplayedOnUIAscending.get(count).getText().trim());
			int secondRegisterIdDisplayedOnUI = Integer
					.parseInt(registerElementsDisplayedOnUIAscending.get(count + 1).getText().trim());
			// Verify the
			Assert.assertTrue(firstRegisteIdDisplayedOnUI <= secondRegisterIdDisplayedOnUI,
		...
		// default
		List<WebElement> registerElementsDisplayedOnUIDDescending = getTaxExemptSalesPage(driver)
				.getListOfRegisterElements();
		for (int count = 0; count < registerElementsDisplayedOnUIDDescending.size() - 1; count++) {
			int firstRegisterIdDislayedOnUIDescending = Integer
					.parseInt(registerElementsDisplayedOnUIDDescending.get(count).getText().trim());
			int secondRegisterDisplayedOnUIDescending = Integer
					.parseInt(registerElementsDisplayedOnUIDDescending.get(count + 1).getText().trim());
			Assert.assertTrue(firstRegisterIdDislayedOnUIDescending >= secondRegisterDisplayedOnUIDescending,
		...
		List<WebElement> amountElementsDisplayedOnUI = getTaxExemptSalesPage(driver).getListOfAmountElements();
		for (int count = 0; count < amountElementsDisplayedOnUI.size() - 2; count++) {
			float firstAmountDisplayedOnUI = Float
					.parseFloat(amountElementsDisplayedOnUI.get(count).getText().replace("$", ""));
			float secondAmountDisplayedOnUI = Float
					.parseFloat(amountElementsDisplayedOnUI.get(count + 1).getText().replace("$", ""));
			Assert.assertTrue(firstAmountDisplayedOnUI <= secondAmountDisplayedOnUI,
					"Amount is not displayed on Ascending Order");
			Reporter.log(firstAmountDisplayedOnUI + " was dislayed in ascending order<br>");
		}
		getTaxExemptSalesPage(driver).taxExemptAmountField.click();
		// Get all the Amount elements as it was in descending order by default
		List<WebElement> amountDisplayedOnUIDescending = getTaxExemptSalesPage(driver).getListOfAmountElements();
		for (int count = 0; count < amountDisplayedOnUIDescending.size() - 2; count++) {
			float firstAmountDisplayedOnUIDescendingOrder = Float
					.parseFloat(amountDisplayedOnUIDescending.get(count).getText().replace("$", ""));
			float secondAmountDisplayedOnUIDescendingOrder = Float
					.parseFloat(amountDisplayedOnUIDescending.get(count + 1).getText().replace("$", ""));
			Assert.assertTrue(firstAmountDisplayedOnUIDescendingOrder >= secondAmountDisplayedOnUIDescendingOrder,
		...
		List<WebElement> userDisplayedOnUIAscending = getTaxExemptSalesPage(driver).getListOfUserID();
		for (int count = 0; count < userDisplayedOnUIAscending.size() - 1; count++) {
			int firstUserDisplayedOnUIAscending = Integer
					.parseInt(userDisplayedOnUIAscending.get(count).getText().trim());
			int secondUserDisplayedOnUIAscending = Integer
					.parseInt(userDisplayedOnUIAscending.get(count + 1).getText().trim());
			Assert.assertTrue(firstUserDisplayedOnUIAscending <= secondUserDisplayedOnUIAscending,
		...
		getTaxExemptSalesPage(driver).taxExemptUserField.click();
		// Get all the User elements as it was in descending order by default
		List<WebElement> userIdDisplayedOnUIDescending = getTaxExemptSalesPage(driver).getListOfUserID();
		for (int count = 0; count < userDisplayedOnUIAscending.size() - 1; count++) {
			int firstUserIdDisplayedOnUIDescending = Integer
					.parseInt(userIdDisplayedOnUIDescending.get(count).getText().trim());
			int secondUserIdDisplayedOnUIDescending = Integer
					.parseInt(userIdDisplayedOnUIDescending.get(count + 1).getText().trim());
			Assert.assertTrue(firstUserIdDisplayedOnUIDescending >= secondUserIdDisplayedOnUIDescending,
		...
		// by default
		List<WebElement> organizationNameDisplayedOnUIAscending = getTaxExemptSalesPage(driver)
				.getListOfOrganizationName();
		for (int count = 0; count < organizationNameDisplayedOnUIAscending.size() - 1; count++) {
			String firstOrganizationNameDisplayedOnUIAscending = organizationNameDisplayedOnUIAscending.get(count)
					.getText().trim();
			String secondOrganizationNameDisplayedOnUIAscending = organizationNameDisplayedOnUIAscending.get(count + 1)
					.getText().trim();
			if (!(firstOrganizationNameDisplayedOnUIAscending.isEmpty()
					|| firstOrganizationNameDisplayedOnUIAscending.contains("Invalid"))) {
				if (!(secondOrganizationNameDisplayedOnUIAscending.isEmpty()
						|| firstOrganizationNameDisplayedOnUIAscending.contains("Invalid"))) {
					Assert.assertTrue(
		...
		// default
		List<WebElement> organizationNameDisplayedOnUIDescending = getTaxExemptSalesPage(driver)
				.getListOfOrganizationName();
		for (int count = 0; count < organizationNameDisplayedOnUIDescending.size() - 1; count++) {
			String firstOrganizationNameDisplayedOnUIDescending = organizationNameDisplayedOnUIDescending.get(count)
					.getText().trim();
			String secondOrganizationNameDisplayedOnUIDescending = organizationNameDisplayedOnUIDescending
					.get(count + 1).getText().trim();
			if (!(firstOrganizationNameDisplayedOnUIDescending.isEmpty()
					|| firstOrganizationNameDisplayedOnUIDescending.contains("Invalid"))) {
				if (!(secondOrganizationNameDisplayedOnUIDescending.isEmpty()
						|| secondOrganizationNameDisplayedOnUIDescending.contains("Invalid"))) {
					Assert.assertTrue(
					...
					Reporter.log(
							firstOrganizationNameDisplayedOnUIDescending + " was dislayed in descending order<br>");
				}
			}
		}
		...
		// default
		List<WebElement> taxIDNumberDisplayedOnUIAscendingOrder = getTaxExemptSalesPage(driver).getListOfTaxIdNumber();
		for (int count = 0; count < taxIDNumberDisplayedOnUIAscendingOrder.size() - 1; count++) {
			String firsttaxIDNumberDisplayedOnUIAscendingOrder = taxIDNumberDisplayedOnUIAscendingOrder.get(count)
					.getText().trim();
			String secondtaxIDNumberDisplayedOnUIAscendingOrder = taxIDNumberDisplayedOnUIAscendingOrder.get(count + 1)
					.getText().trim();
			if (!(firsttaxIDNumberDisplayedOnUIAscendingOrder.isEmpty()
					|| firsttaxIDNumberDisplayedOnUIAscendingOrder.contains("Invalid"))) {
				if (!(secondtaxIDNumberDisplayedOnUIAscendingOrder.isEmpty()
						|| secondtaxIDNumberDisplayedOnUIAscendingOrder.contains("Invalid"))) {
					Assert.assertTrue(
		...
		// Get all the TaxId Numbers elements as it was in descending order by
		// default
		List<WebElement> taxIDNumberDisplayedOnUIDescendingOrder = getTaxExemptSalesPage(driver).getListOfTaxIdNumber();
		for (int count = 0; count < taxIDNumberDisplayedOnUIDescendingOrder.size() - 1; count++) {
			String firsttaxIDNumberDisplayedOnUIDescendingOrder = taxIDNumberDisplayedOnUIDescendingOrder.get(count)
					.getText().trim();
			String secondtaxIDNumberDisplayedOnUIDescendingOrder = taxIDNumberDisplayedOnUIDescendingOrder
					.get(count + 1).getText().trim();
			if (!(firsttaxIDNumberDisplayedOnUIDescendingOrder.isEmpty()
					|| firsttaxIDNumberDisplayedOnUIDescendingOrder.contains("Invalid"))) {
				if (!(secondtaxIDNumberDisplayedOnUIDescendingOrder.isEmpty()
						|| secondtaxIDNumberDisplayedOnUIDescendingOrder.contains("Invalid"))) {
					Assert.assertTrue(
					...
					Reporter.log(
							firsttaxIDNumberDisplayedOnUIDescendingOrder + " was dislayed in descending order<br>");
				}
		...
		// default
		List<WebElement> depositStatusDisplayedOnUIAscendingOrder = getTaxExemptSalesPage(driver)
				.getListOfDepositStatus();
		for (int count = 0; count < depositStatusDisplayedOnUIAscendingOrder.size() - 1; count++) {
			String firstDepositStatusDisplayedOnUIAscendingOrder = depositStatusDisplayedOnUIAscendingOrder.get(count)
					.getText().trim();
			String secondDepositStatusDisplayedOnUIAscendingOrder = depositStatusDisplayedOnUIAscendingOrder
					.get(count + 1).getText().trim();
			if (!(firstDepositStatusDisplayedOnUIAscendingOrder.isEmpty()
					|| firstDepositStatusDisplayedOnUIAscendingOrder.contains("Invalid"))) {
				if (!(secondDepositStatusDisplayedOnUIAscendingOrder.isEmpty()
						|| secondDepositStatusDisplayedOnUIAscendingOrder.contains("Invalid"))) {
					Assert.assertTrue(
					...
					Reporter.log(
							firstDepositStatusDisplayedOnUIAscendingOrder + " was dislayed in ascending order<br>");
				}
		...
		// Get all the Deposit Status elements as it was in descending order by
		// default
		List<WebElement> depositStatusDisplayedOnUIDescendingOrder = getTaxExemptSalesPage(driver)
				.getListOfDepositStatus();
		for (int count = 0; count < depositStatusDisplayedOnUIDescendingOrder.size() - 1; count++) {
			String firstDepositStatusDisplayedOnUIDescendingOrder = depositStatusDisplayedOnUIDescendingOrder.get(count)
					.getText().trim();
			String secondDepositStatusDisplayedOnUIDescendingOrder = depositStatusDisplayedOnUIDescendingOrder
					.get(count + 1).getText().trim();
			if (!(firstDepositStatusDisplayedOnUIDescendingOrder.isEmpty()
					|| firstDepositStatusDisplayedOnUIDescendingOrder.contains("Invalid"))) {
				if (!(secondDepositStatusDisplayedOnUIDescendingOrder.isEmpty()
						|| secondDepositStatusDisplayedOnUIDescendingOrder.contains("Invalid"))) {
					Assert.assertTrue(
					...
					Reporter.log(
							firstDepositStatusDisplayedOnUIDescendingOrder + " was dislayed in descending order<br>");
				}
